...
from pyclarify.importer import CsvImporter
...
class TestCsvImporter(unittest.TestCase):
    ...
    def test_send_insert(self, client_req_mock, get_token_mock):
        ...
        csv_importer1 = CsvImporter(".tests/data/mock-csv-sep-comma.csv")
        csv_importer1.read_csv(delimiter=",")
        csv_importer1.insert_csv_data(self.client, labels_dict=None)

        csv_importer2 = CsvImporter(".tests/data/mock-csv-sep-semicolon-time-col2.csv")
        csv_importer2.read_csv(delimiter=";", time_index_column=1)
        csv_importer2.insert_csv_data(self.client, labels_dict=None)
        ...
        csv_importer3.insert_csv_data(self.client, labels_dict=None)
        self.assertDictEqual(csv_importer3.data, csv_importer1.data)

        csv_importer4 = CsvImporter(".tests/data/mock-csv-sep-comma-enum.csv")
        csv_importer4.read_csv(delimiter=",", time_index_column=3)
        csv_importer4.insert_csv_data(self.client, labels_dict=None)
        self.assertEqual(
